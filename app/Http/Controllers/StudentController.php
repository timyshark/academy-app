...
class StudentController extends Controller
{
    ...
    public function index()
    {
        ...
        $students = DB::table('students')
            ...
            ->select('students.id', 'students.first_name', 'students.last_name', 'students.email','students.isActive','students.gender','schools.name as school','students.dob','students.picturePath')
            ->get();
        return $students;
    }
